...
export type containerMarginType = 'sm' | 'base' | 'lg';
export type containerSpaceType = 'tight' | 'base' | 'sparse';
export type imgSizeType = 'xs' | 'sm' | 'base' | 'lg';
export type messageModeType = 'sm' | 'base' | 'lg';
