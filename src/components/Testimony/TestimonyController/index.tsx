...
export type imgBorderType = 'full' | 'none' | 'xl';
export type imgContainerType = 'sm' | 'base' | 'lg';
        ...
        <div tw="container mx-auto flex flex-col space-y-10 md:space-y-0 items-center justify-center md:px-4 px-16 mt-0 md:mt-16 mb-24 md:mb-48">
            ...
            <div tw="hidden md:flex flex-row space-x-8">
                {testiList.map((val, index) => (
                    <div
                        key={index}
                        css={[index === selected && onSelected, tw`relative`, imgContainerMap[imgContainer]]}
                    >
                        <img
...
const dataTesti = [
    {
        ...
        message: (
            <span>
                ...
                <GradientText gr1={'ed1c7d'} gr2={'cd33d5'} gr3={'5824fe'} tw="inline font-bold">
                    {' '}
                ...
                <GradientText gr1={'ed1c7d'} gr2={'cd33d5'} gr3={'5824fe'} tw="inline font-bold">
                    {' '}
                    kesempatan magang di perusahaan multinasional di industri teknologi dan FMCG.
                </GradientText>
                ”
            </span>
        ),
    ...
    },
    {
        ...
        message: (
            <span>
                “Melalui acara ini, saya menemukan berbagai masalah yang tidak saya sadari sebelumnya dan
                <GradientText gr1={'ed1c7d'} gr2={'cd33d5'} gr3={'5824fe'} tw="inline font-bold">
                    {' '}
    ...
    },
    {
        ...
        message: (
            <span>
                ...
                untuk meningkatkan pengetahuan UX-ku. Seneng banget karena bisa bertemu dengan
                <GradientText gr1={'ed1c7d'} gr2={'cd33d5'} gr3={'5824fe'} tw="inline font-bold">
                    {' '}
    ...
    },
    {
        ...
        message: (
            <span>
                “Software Engineering Academy COMPFEST merupakan tempat belajar Software Engineering dengan cara yang
                seru. Aku mendapat banyak
                <GradientText gr1={'ed1c7d'} gr2={'cd33d5'} gr3={'5824fe'} tw="inline font-bold">
                    {' '}
