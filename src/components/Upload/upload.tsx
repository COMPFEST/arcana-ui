        ...
        <Dropzone multiple={false} onDrop={onDrop} accept={allowedExtensions}>
            {({ getRootProps, getInputProps }) => (
                <div
                    ...
                    css={[uploaded ? tw`border-green-500 bg-green-100` : tw`border-dashed`]}
                >
                    <div {...getRootProps()}>
                        <input {...getInputProps()} />
                        ...
                        {!uploaded ? (
                            <>
                                <div className="upload-file" tw="flex justify-center cursor-pointer">
                                    <svg
                                        width="49"
                                        height="34"
                                        viewBox="0 0 49 34"
                            ...
                            <div tw="flex flex-col items-center justify-center">
                                ...
                                <h1 tw="text-green-600 font-bold mt-4">File telah terupload!</h1>
                                <div tw="flex flex-row space-x-1">
                                    ...
                                    <a
                                        ...
                                        href={`${
                                            process.env.NEXT_PUBLIC_ARCANUM_BASE_URL || 'https://arcanum.compfest.id'
