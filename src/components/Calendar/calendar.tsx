...
import { compareDateEquals, dateToStringEN, dateToStringID } from './utils/funcs';
...
const CalendarComponent: React.FC<MyCalendarProps> = ({ data = [] }) => {
    ...
    const onMouseEnter = (e: MouseEvent<HTMLDivElement, globalThis.MouseEvent>) => {
        ...
        try {
            ...
            const filteredEvents = data.filter((d) => compareDateEquals(new Date(d.event_start), realDate));
